...
De plus, on peut noter que le jeu de données possède 31 lignes. - - \### Nombre de sites olympiques et paralympiques - - Plusieurs sites ont été prévus pour accueillir les différentes disciplines qui auront lieu pendant les JO de Paris 2024. Il y aura 26 sites olympiques et 19 sites paralympiques et certains sites accueilleront à la fois des disciplines olympiques et des disciplines paralympiques.
...
\- - \### Les disciplines accueillies - - Concernant les disciplines accueillies sur les différents sites :
...
\- - \### Situation géographique des sites olympiques - - Enfin, si on s'intéresse aux positions géographiques des différents sites, nous pouvons faire plusieurs constats.
